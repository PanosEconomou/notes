...
$$
\begin{align*} d\ast F = J && dF = 0 \end{align*}
$$
...
Let’s call the field solution of the solenoid $F\_s = E\_s \wedge dt + dA\_s$ where $A\_s$ is the magnetic field 2 form. We know that
...
$$
\begin{align*} \phi^1 = \phi^2 = 0 && \phi^3 = v + \eta, \end{align*}
$$

for some $\eta \in C^\infty(M)$. Remember that in this case the Higgs field $\phi$ is also lie algebra valued map on the base space. In the gauge where $A\_0^a = 0$ $\frac{\partial A\_i}{\partial t} = 0$ and $\frac{\partial \phi}{\partial t} = 0$.
