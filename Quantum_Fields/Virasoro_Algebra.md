...
**<u>Definition:</u>** The **Virasoro Algebra** $\text{Vir}$ is the central extension of the Witt algebra $W$ by $\mathbb{C}$, given by
$$
...
**<u>Definition:</u>** Given a Verma module $V$, a **Verma submodule $A$ of** $V$ is a vector subspace space $A \subset V$ such that $A$ is invariant under the representation of the Virasoro algebra.  

**<u>Theorem:</u>** The kernel of $H$ is a maximal proper Verma submodule of $M$. In other words that kernel is the biggest possible Verma module with that $h,c$ as highest weight and central charge that is strictly included in $M$. Elements of $\text{ker}H$ are called **singular, or null vectors** 

**<u>Corollary:</u>** $M/\text{ker} H$ is an irreducible highest weight representation of the Virasoro algebra. 
